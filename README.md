...
# 二、方案应用场景地点：
  ...
  功能：  
    ...
    2、将每次投放食物重量、以及投放时间、吃完时间，后台记录，并可供主人查看分析，根据宠物身长体重年龄，提供食量建议（算法参考下方截图）；  
    3、喂水罐水压监测传感器，监测水量水位，如果水量不足及时提醒主人；  
    4、在食物盘底部加入重量传感器，记录食物盘的重量变化；  
    5、加大食物储存器，以及开发余粮监测（主子食量有点大），争取做到一周加一次粮；  
    6、喂食器旁有可供旺财按压的按钮，每次按压，投放少量食物（可对总量进行限制）；  
   ...
   涉及参考内容：   
   ![image](https://user-images.githubusercontent.com/26399615/110764469-11c4a900-828e-11eb-981b-4bad9219e4f4.png)
